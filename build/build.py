...
from stages import run as stages_to_run
from stages.base import BuildState

state = BuildState()
build_dir_path = Path(__file__).parent

for stage_class in stages_to_run:
    stage_instance = stage_class(state, build_dir_path)
    stage_instance.task()
